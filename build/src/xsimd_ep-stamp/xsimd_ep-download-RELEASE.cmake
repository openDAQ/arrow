...
set(command "/usr/bin/cmake;-Dmake=${make};-Dconfig=${config};-P;/home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-download-RELEASE-impl.cmake")
set(log_merged "")
set(log_output_on_failure "1")
set(stdout_log "/home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-download-out.log")
set(stderr_log "/home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-download-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep download command succeeded.  See also /home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-download-*.log")
    message(STATUS "${msg}")
  endif()
endif()
