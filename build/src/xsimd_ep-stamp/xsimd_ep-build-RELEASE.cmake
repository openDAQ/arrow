...
set(stdout_log "/home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-build-out.log")
set(stderr_log "/home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep build command succeeded.  See also /home/roettger/projects/arrow/build/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
