...
#  define je_aligned_alloc je_arrow_aligned_alloc
#  define je_calloc je_arrow_calloc
#  define je_dallocx je_arrow_dallocx
#  define je_free je_arrow_free
#  define je_mallctl je_arrow_mallctl
#  define je_mallctlbymib je_arrow_mallctlbymib
#  define je_mallctlnametomib je_arrow_mallctlnametomib
#  define je_malloc je_arrow_malloc
#  define je_malloc_conf je_arrow_malloc_conf
#  define je_malloc_conf_2_conf_harder je_arrow_malloc_conf_2_conf_harder
#  define je_malloc_message je_arrow_malloc_message
#  define je_malloc_stats_print je_arrow_malloc_stats_print
#  define je_malloc_usable_size je_arrow_malloc_usable_size
#  define je_mallocx je_arrow_mallocx
#  define je_smallocx_54eaed1d8b56b1aa528be3bdd1877e59c56fa90c je_arrow_smallocx_54eaed1d8b56b1aa528be3bdd1877e59c56fa90c
#  define je_nallocx je_arrow_nallocx
#  define je_posix_memalign je_arrow_posix_memalign
#  define je_rallocx je_arrow_rallocx
#  define je_realloc je_arrow_realloc
#  define je_sallocx je_arrow_sallocx
#  define je_sdallocx je_arrow_sdallocx
#  define je_xallocx je_arrow_xallocx
#  define je_memalign je_arrow_memalign
#  define je_valloc je_arrow_valloc
#endif
