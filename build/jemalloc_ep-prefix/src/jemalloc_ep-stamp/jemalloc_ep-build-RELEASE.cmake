...
set(command "/usr/bin/make;-j16")
set(log_merged "")
set(log_output_on_failure "1")
set(stdout_log "/home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-build-out.log")
set(stderr_log "/home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "jemalloc_ep build command succeeded.  See also /home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
