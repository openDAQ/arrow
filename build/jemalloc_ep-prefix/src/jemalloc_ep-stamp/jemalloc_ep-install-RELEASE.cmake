...
set(stdout_log "/home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-install-out.log")
set(stderr_log "/home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "jemalloc_ep install command succeeded.  See also /home/roettger/projects/arrow/build/jemalloc_ep-prefix/src/jemalloc_ep-stamp/jemalloc_ep-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
